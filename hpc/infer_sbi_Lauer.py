...
#for i in range(1):
    ...
    np.savetxt(path + out + "_gln_" + str(i+1) + "_SNPE_posterior_samples.csv", posterior_samples, delimiter=",")
    np.savetxt(path + out + "_gln_" + str(i+1) + "_SNPE_posterior_logprob.csv", log_probability, delimiter=",")
