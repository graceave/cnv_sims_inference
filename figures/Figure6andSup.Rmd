...
labels=c("0.001_1e-05"  = expression(atop(paste(italic("s"[B])," = 0.001,"), paste(italic(delta[B]), "  = 1e-5"))),
         "0_0" = expression(atop(paste(italic("s"[B])," = 0,"), paste(italic(delta[B]), "  = 0"))), 
...
sup = a / b + plot_annotation(tag_levels = 'A') 
sup
ggsave(paste0(fig_path,"SupplementaryFigure12.pdf"), plot = sup, width = 15, height = 10, units = "in")
ggsave(paste0(fig_path,"SupplementaryFigure12.png"), plot = sup, width = 15, height = 10, units = "in")
```
